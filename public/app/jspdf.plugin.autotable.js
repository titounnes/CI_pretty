...
exports.Cell = Cell;
var Column = (function () {
    function Column(dataKey, index, width) {
        this.options = {};
        this.contentWidth = 0;
        this.preferredWidth = 0;
        this.widthStyle = dataKey.width;
        this.width = dataKey.width;
        this.x = 0;
...
function createModels(inputHeaders, inputData) {
    ...
    inputHeaders.forEach(function (rawColumn, index) {
        ...
        col.raw = rawColumn;
        console.log(table.styles.columnStyles[col.dataKey])
        col.widthStyle = config_1.Config.styles([theme.table, theme.header, table.styles.styles, table.styles.columnStyles[col.dataKey] || {}]).columnWidth[rawColumn.width];
        table.columns.push(config_1.Config.styles([theme.table, theme.header, table.styles.styles, table.styles.columnStyles[col.dataKey] || {}]).columnWidth[rawColumn.width]);
