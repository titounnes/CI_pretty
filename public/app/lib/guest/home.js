...
var callInfo = function() {
  ...
  $('#dialog-body').html('')
  getLib('showInfo', 'guest/info');
}
var callRegister = function() {
  triger.attr('disabled', false)
  $('#dialog-body').html('')
  getLib('showRegister', 'guest/auth');
}
var callLogin = function() {
  triger.attr('disabled', false)
  $('#dialog-body').html('')
  getLib('showLogin', 'guest/auth');
}
var callHelp = function() {
  triger.attr('disabled', false)
  $('#dialog-body').html('')
  getLib('showHelp', 'guest/help');
}
...
var callList = function() {
  ...
  triger.attr('disabled', false)
  id = '';
  getLib('showList', 'guest/list');
}
var callList2 = function() {
  $('#myCarousel').show()
  triger.attr('disabled', false)
  getLib('showList2', 'guest/list2');
}
var dataHome = {
  title: [
  ...
  gallery: [{
      src: 'assets/img/1.png?a=1',
      caption: 'Judul 1',
      description: 'Ini judul 1',
    },
    {
      src: 'assets/img/2.png?a=1',
      caption: 'Judul 2',
